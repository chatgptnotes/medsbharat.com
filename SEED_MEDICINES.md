# How to Seed Common Medicines

## Quick Method: Use Supabase SQL Editor

### Step 1: Open Supabase SQL Editor
Visit: https://supabase.com/dashboard/project/hcacdavejbbzqzqjoqbp/sql
...
-- Show summary
SELECT
    COUNT(*) as total_medicines_created,
    COUNT(DISTINCT name) as unique_medicines,
    COUNT(DISTINCT "pharmacyId") as pharmacies_count
FROM "Medicine";
```
...
```
total_medicines_created: 270 (45 medicines × 6 pharmacies)
unique_medicines: 45
pharmacies_count: 6
```
...
- **45 unique common medicines** across all categories
- Each medicine added to **all 6 pharmacies**
- **Total: 270 medicine entries**
- Price variations (±15%) between pharmacies
- Random stock levels and discounts

## Test Your Features

Now visit: http://localhost:3000/search?q=dolo&type=medicine

You can test:
- Search for "Dolo", "Glycomet", "Pantoprazole"
